...
The key performance indicator (KPI) used throughout the report is "hires", indicating the frequency that bikes are borrowed from one of the stations in the bike network.  The length of bike hires is also considered as a KPI to examine the way the bikes are being used.
